...
public class ThirdyearFragment extends Fragment implements classAdapter.ListItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mbase = FirebaseDatabase.getInstance().getReference("Elements").child("Third year");

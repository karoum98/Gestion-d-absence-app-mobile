...
public class FirstyearFragment extends Fragment implements classAdapter.ListItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mbase = FirebaseDatabase.getInstance().getReference("Elements").child("First year");
